"""
Django settings for parknow project.
...
SECRET_KEY = 'p3ndr@_k_w@ei&w+9-eo1*c-@%kegfz-z+2=cs&^33ez=quaom'
...
WSGI_APPLICATION = 'parknow.wsgi.application'
